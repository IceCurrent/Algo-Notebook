...
int main(){
    ...
    //This maxHeap approach takes O(n + klogn) time 
    priority_queue<int> pq(arr+0, arr+5);
    ...
    //This minHeap approach O(k + (n-k)*logk);
    priority_queue<int, vi, greater<int> > pqM(arr+0, arr+k);
